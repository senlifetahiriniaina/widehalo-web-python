...
| **L1 bis** — second relèvement, seuil de la Vague 2 | ✅ livré | Celui que le premier annonçait, au moment prévu : Vague 1 close, Vague 2 pas commencée. **+25 % décidé par l'utilisateur** — 519 / 1 000 / 400. Consommation mesurée au relèvement : 305 / 589 / 252. **Une réserve qui doit être lue** : rapporté aux projections du cahier Phase 4 (430 modèles / 1 210 endpoints / 278 écrans), +25 % couvre les modèles et les écrans largement, mais **pas les endpoints** — 1 000 < 1 210, il manque 210. L'écart vient presque entièrement de la surface d'API publique du **Bloc B** (S7–S9). Le plafond redeviendra donc bloquant **en cours** de Vague 2, à ce bloc précis, et non à son démarrage. 1 250 couvrirait la projection ; non appliqué faute de décision en ce sens. |
