...
| §3.2 Budgets d'architecture | ❓ non mesurables | Mesurés le jour même (300 / 576 / 240) et relevés de +33 % à **415 / 800 / 320**. Puis, au seuil de la Vague 2, second relèvement de **+25 %** décidé par l'utilisateur : **519 / 1 000 / 400**, pour une consommation mesurée de 305 / 589 / 252. Réserve à connaître : les endpoints restent **sous** la projection Phase 4 (1 000 < 1 210), l'écart venant du Bloc B — le plafond redeviendra bloquant en cours de Vague 2, pas à son démarrage. |
