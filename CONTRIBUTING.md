...
- `widehalo/tests/architecture/test_budget.py` fait échouer la CI si le
  ...
  `widehalo/config/settings/base.py` — **519 / 1 500 / 400** à ce jour. Un plafond
  ne se relève jamais sans décision explicite actée avec l'utilisateur et
  commentée sur place (huit décisions de relèvement y sont documentées, chacune actée avec l'utilisateur).
