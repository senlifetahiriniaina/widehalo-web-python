...
le droit d'importer. Couvre `get_order_reference` (deja existant ;
`get_quotation_reference`, sans consommateur possible, a ete supprimee en
H-2) et le gap ajoute par `stocks` ST6 (RG-STK-6) :
