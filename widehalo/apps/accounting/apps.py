...
class AccountingConfig(AppConfig):
    ...
    def ready(self) -> None:
        ...
        from apps.accounting.services.next_steps_registration import register as register_next_steps
        ...
        from apps.accounting.services.document_screen_registration import (
