...
def _default_entries(year: int) -> list[dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "label": _("TVA — déclaration mensuelle"),
            "due_date": dt.date(year, 2, 15),
            "periodicity": AccTaxCalendar.PERIODICITY_MONTHLY,
        },
        {
